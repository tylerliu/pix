...
%result3 = fptrunc double %temp2 to float
%result4 = fptrunc double %temp3 to float
%result1_int = fptosi float %result1 to i64
%result2_int = fptosi float %result2 to i64
%result3_int = fptosi float %result3 to i64
%result4_int = fptosi float %result4 to i64
