...
%result2 = inttoptr i64 %temp1 to i8*
%result3 = inttoptr i64 %temp2 to i8*
%result4 = inttoptr i64 %temp3 to i8*
%result1_int = ptrtoint i8* %result1 to i64
%result2_int = ptrtoint i8* %result2 to i64
%result3_int = ptrtoint i8* %result3 to i64
%result4_int = ptrtoint i8* %result4 to i64
