...
%idx1 = and i64 %seed1, 4095 ; mask to 4096 entries (32KB working set)
%idx2 = and i64 %seed2, 4095
%idx3 = and i64 %seed3, 4095
%idx4 = and i64 %seed4, 4095
...
; Load from 1 location
%val1 = load i64, i64* %ptr1

; Sum both loaded values and pointer values
%sum1 = add i64 %val1, %val1
%sum2 = add i64 %val1, %val1
